...
void main() {
  ...
  `}),pf=new ii(new ma(2,2),ff);uf.add(pf);var mf=null,hf=null,gf=``,_f=[],vf=null,yf=``,bf=0,xf=new Map,Sf=!1,Cf=0,wf=null,Tf=[],Ef=``,Df=null,Of=``,kf=``,Af=!1,jf=!1,Mf=!1,Nf=!1,Pf=8,Ff=Object.freeze({sphere:{label:`구체`,color:12154942,create:()=>new ha(2,64,40)},cube:{label:`정육면체`,color:5402013,cameraDistanceScale:1.16,create:()=>new ua(3.5,3.5,3.5,10,10,10)},torus:{label:`토러스`,color:6718828,create:()=>new ga(1.65,.62,32,96),rotation:[.34,-.42,.12]},knot:{label:`매듭`,color:10444120,create:()=>new _a(1.35,.42,160,28,2,3),rotation:[.2,-.35,-.12]}}),If=new lo(11257320,7095071,2.2);af.add(If);var Lf=new ko(16777215,2.8);Lf.position.set(-5,9,4),af.add(Lf);function Rf(e,t={}){let n=Mt.clamp(Number(e)||0,-180,180),r=Mt.degToRad(n);X.modelLightAngle=n,Lf.position.set(Math.sin(r)*7.5,8.5,Math.cos(r)*7.5),Lf.updateMatrixWorld(),md.value=String(Math.round(n)),hd.textContent=`${Math.round(n)}°`,document.documentElement.dataset.modelLightAngle=String(Math.round(n)),Sp=!0,Np=!0,wf&&(jf=!0),t.finalize&&(yp=!0,Y.textContent=`환경광 각도 · ${Math.round(n)}°`,Fm()),nm()}var zf=[],Bf;function Vf(e,t){return e.userData.semantic=t,zf.push(e),af.add(e),e}function Hf(){Bf=new Ea({side:2,depthWrite:!1,uniforms:{uTime:{value:0}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
